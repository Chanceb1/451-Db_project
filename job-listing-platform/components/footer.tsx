    ...
    <footer className="w-full border-t bg-background">
      <div className="container py-10">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4">
          <div>
            <h3 className="text-lg font-semibold">JobHub</h3>
            <p className="mt-2 text-sm text-muted-foreground">
              Find your dream job or hire the perfect candidate with our comprehensive job listing platform.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="mt-2 space-y-2">
              <li>
                <Link href="/employer/register" className="text-sm text-muted-foreground hover:text-foreground">
                  Post a Job
                </Link>
              </li>
              <li>
